        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="list-product.html"><i class="fas fa-window-maximize"></i><span>Blank Page</span></a></li>
                </ul>
            ...
            <div class="container-fluid">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-field">
                        ...
                        <div class="form-row">
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="Name"></div>
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="ID"></div>
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="GST"></div>
                    ...
                    <div class="form-field">
                        ...
                        <div class="form-row">
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="Name"></div>
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="Category"></div>
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="Packet Quantity"></div>
                            <div class="col-xl-3"><input class="form-control" type="text" placeholder="Total in a Packet"></div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row submit-row">
                            <div class="col-xl-2 offset-xl-10"><button class="btn btn-primary btn-block" type="submit"><strong>Submit</strong></button></div>
                        </div>
                    </div>
                    <!-- End: Form-Field -->
                </form>
                <!-- End: new-product-add-form -->
                <!-- Start: Table-Field -->
                        ...
                        <div class="form-group">
                            <div class="table-responsive data">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input class="form-control" type="text" value="5873"></td>
                                            <td><input class="form-control" type="text" value="Keyboard"></td>
                                            <td><input class="form-control" type="text" value="KB256" disabled=""></td>
                                            <td><input class="form-control" type="text" value="Red"></td>
                                            <td><input class="form-control" type="text" value="Plastic"></td>
                                            <td><input class="form-control" type="text" value="Computer"></td>
                                            <td><input class="form-control" type="text" value="admin" disabled=""></td>
                                            <td>
                                                <div class="btn-group" role="group"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-pencil"></i></button><button class="btn btn-warning btn-sm" type="button"><i class="fa fa-trash"></i></button></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="form-row submit-row">
                                <div class="col-xl-2 offset-xl-10"><button class="btn btn-primary btn-block" type="submit"><strong>Add Products</strong></button></div>
                            </div>
                        </div>
                    </form>
                </div>
